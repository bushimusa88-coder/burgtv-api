...
export const deviceRegistrationSchema = z.object({
  ...
  device_name: z.string().min(1).max(50).nullable().optional(),
  m3u_url: m3uUrlSchema,
  epg_url: urlSchema.nullable().optional(),
  captcha_token: z.string().nullable().optional() // Temporarily optional for testing
});
